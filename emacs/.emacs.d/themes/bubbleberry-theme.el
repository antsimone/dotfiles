...
(custom-theme-set-faces
 ...
 ;; basic theming.
 '(default                          ((t (:foreground "#EEEEEE" :background "#1B1B1B" ))))
 '(region                           ((t (:background "#151515" ))))
 '(cursor                           ((t (:background "#EEEEEE" ))))
 '(fringe                           ((t (:background "#2F2F2F" :foreground "#FFFFFF" ))))
 '(linum                            ((t (:background "#1B1B1B" :foreground "#777777" :box nil :height 100 ))))
 ...
 '(highlight
   ((((class color) (min-colors 88) (background light)) (:background "#003453"))
    (((class color) (min-colors 88) (background dark))  (:background "#606060"))
    (((class color) (min-colors 16) (background light)) (:background "#003450"))
    (((class color) (min-colors 16) (background dark))  (:background "#606060"))
